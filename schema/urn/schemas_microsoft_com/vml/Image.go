	...
	for {
		...
		case xml.StartElement:
			...
			case xml.Name{Space: "urn:schemas-microsoft-com:office:powerpoint", Local: "textdata"}:
				...
				m.EG_ShapeElements = append(m.EG_ShapeElements, tmpshapeelements)
			default:
				unioffice.Log("skipping unsupported element on Image %v", el.Name)
...
func (m *Image) Validate() error {
	return m.ValidateWithPath("Image")
}
...
func (m *Image) ValidateWithPath(path string) error {
	if err := m.CT_Image.ValidateWithPath(path); err != nil {
		return err
	}
	return nil
}
