...
func (m *Oval) Validate() error {
	return m.ValidateWithPath("Oval")
}
...
func (m *Oval) ValidateWithPath(path string) error {
	if err := m.CT_Oval.ValidateWithPath(path); err != nil {
		return err
	}
	return nil
}
