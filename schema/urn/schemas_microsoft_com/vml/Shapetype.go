...
func (m *Shapetype) Validate() error {
	return m.ValidateWithPath("Shapetype")
}
...
func (m *Shapetype) ValidateWithPath(path string) error {
	if err := m.CT_Shapetype.ValidateWithPath(path); err != nil {
		return err
	}
	return nil
}
