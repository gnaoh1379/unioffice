	...
	for {
		...
		case xml.StartElement:
			...
			case xml.Name{Space: "http://schemas.openxmlformats.org/drawingml/2006/main", Local: "hlinkHover"},
				xml.Name{Space: "http://purl.oclc.org/ooxml/drawingml/main", Local: "hlinkHover"}:
			...
			default:
				unioffice.Log("skipping unsupported element on CT_NonVisualDrawingProps %v", el.Name)
