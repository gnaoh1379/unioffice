...
func (m *CT_PictureNonVisual) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	...
	secNvPicPr := xml.StartElement{Name: xml.Name{Local: "cNvPicPr"}}
...
lCT_PictureNonVisual:
	for {
		...
		case xml.StartElement:
			...
			case xml.Name{Space: "http://schemas.openxmlformats.org/drawingml/2006/chartDrawing", Local: "cNvPicPr"}:
