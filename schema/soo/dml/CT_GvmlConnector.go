...
lCT_GvmlConnector:
	for {
		...
		case xml.StartElement:
			switch el.Name {
			case xml.Name{Space: "http://schemas.openxmlformats.org/drawingml/2006/main", Local: "nvCxnSpPr"},
				xml.Name{Space: "http://purl.oclc.org/ooxml/drawingml/main", Local: "nvCxnSpPr"}:
			...
			default:
				unioffice.Log("skipping unsupported element on CT_GvmlConnector %v", el.Name)
