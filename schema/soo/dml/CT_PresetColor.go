	...
	for {
		...
		case xml.StartElement:
			...
			case xml.Name{Space: "http://schemas.openxmlformats.org/drawingml/2006/main", Local: "invGamma"},
				...
				m.EG_ColorTransform = append(m.EG_ColorTransform, tmpcolortransform)
			default:
				unioffice.Log("skipping unsupported element on CT_PresetColor %v", el.Name)
				if err := d.Skip(); err != nil {
					return err
				}
			}
		case xml.EndElement:
			break lCT_PresetColor
		case xml.CharData:
		}
	}
	return nil
...
func (m *CT_PresetColor) Validate() error {
	return m.ValidateWithPath("CT_PresetColor")
}
...
func (m *CT_PresetColor) ValidateWithPath(path string) error {
	if m.ValAttr == ST_PresetColorValUnset {
