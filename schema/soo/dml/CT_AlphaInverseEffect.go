...
lCT_AlphaInverseEffect:
	for {
		...
		case xml.StartElement:
			...
			default:
				unioffice.Log("skipping unsupported element on CT_AlphaInverseEffect %v", el.Name)
				if err := d.Skip(); err != nil {
					return err
				}
			}
		case xml.EndElement:
			break lCT_AlphaInverseEffect
		case xml.CharData:
		}
	}
	return nil
...
func (m *CT_AlphaInverseEffect) Validate() error {
	return m.ValidateWithPath("CT_AlphaInverseEffect")
}
