...
func NewCT_SolidColorFillProperties() *CT_SolidColorFillProperties {
	ret := &CT_SolidColorFillProperties{}
	return ret
}
...
lCT_SolidColorFillProperties:
	for {
		...
		case xml.StartElement:
			...
			default:
				unioffice.Log("skipping unsupported element on CT_SolidColorFillProperties %v", el.Name)
				if err := d.Skip(); err != nil {
					return err
				}
			}
		case xml.EndElement:
			break lCT_SolidColorFillProperties
		case xml.CharData:
		}
	}
	return nil
...
func (m *CT_SolidColorFillProperties) Validate() error {
	return m.ValidateWithPath("CT_SolidColorFillProperties")
}
