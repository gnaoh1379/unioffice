	...
	for {
		...
		case xml.StartElement:
			...
			case xml.Name{Space: "http://schemas.openxmlformats.org/presentationml/2006/main", Local: "rCtr"},
				xml.Name{Space: "http://purl.oclc.org/ooxml/presentationml/main", Local: "rCtr"}:
				m.RCtr = NewCT_TLPoint()
				if err := d.DecodeElement(m.RCtr, &el); err != nil {
					return err
				}
			default:
				unioffice.Log("skipping unsupported element on CT_TLAnimateMotionBehavior %v", el.Name)
