...
import (
	...
	"github.com/gnaoh1379/unioffice/schema/soo/ofc/extended_properties"
)
...
func NewAppProperties() AppProperties {
	...
	p.SetApplication("github.com/gnaoh1379/unioffice")
	p.SetDocSecurity(0)
...
// For unioffice created documents, it defaults to github.com/gnaoh1379/unioffice
